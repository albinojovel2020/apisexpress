...
app.get('/amphibians', (req, res) => {
    const amphibians = [
        ...
        },
        {
            ...
            "type": "Toad",
            "description": "This toad is typically found in South America. Specifically on Mount Roraima at the boarders of Venezuela, Brazil, and Guyana, hence the name. The Roraima Bush Toad is typically black with yellow spots or marbling along the throat and belly.",
